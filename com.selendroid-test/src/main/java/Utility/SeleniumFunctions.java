...
public class SeleniumFunctions {
	...
	//In this java class, we have all commonly used functions to automate or use in test cases
	...
	public static SeleniumFunctions getInstance() {
		return new SeleniumFunctions();
	}
	...
	//perform actions like click , sublit, or select, launch app
	public void perform(String action, By by, String data) {
		...
		case "JAVASCRIPT":
			...
			break;
		default:
			throw new InvalidArgumentException("This is an invalid action ");
		}
	}
	//all kind of waits 
	...
	public void staticWait(String seconds) {
		try {
			...
			throw new IllegalArgumentException("Wrong wait");
		}
	}
